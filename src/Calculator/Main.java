...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Приветствую, Я - ваш калькулятор!");
        ...
        while (true) {
            ...
            switch (itsRome) {
                case (0):
                    ...
                    if (result <= 0) throw new IllegalArgumentException("Ошибка - в римской системе счисления нет чисел меньше единицы.");
                        System.out.println("Вот ваш результат:");
